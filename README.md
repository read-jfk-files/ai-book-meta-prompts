...
16. Note 3: After you use this sytem enough times, your bookshelf of HTML Reader's Guide book files will grow and become too large to manage. Then you need another local mini web app to be a bookshelf to show all of your AI books. I had ChatGPT generate this app for me, and here is the example screenshot of what a full library bookshelf looks like: [math.guides.bookshelf.png](./math.guides.bookshelf.png). The code for that bookshelf is outside the scope of this repo, but it's a lot simpler to create than it appears. The whole bookshelf web app is just another single HTML file with a lot of Javascript inside it. If you feed that screenshot to ChatGPT and tell it "clone this local web app to be a bookshelf that links to a folder containing math book HTML files", I bet AI will generate the same app for you. I literally wrote zero of the code for this bookshelf app. ChatGPT figured it out all and correctly one-shotted it.
